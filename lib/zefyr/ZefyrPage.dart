...
import 'package:flutter_hero/zefyr/mark_down_convert.dart';
...
class ZefyrPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return ZefyrPageState();
  }
}
...
Delta getDelta() {
  return Delta.fromJson(json.decode(doc) as List)??Delta();
}

class ZefyrPageState extends State<ZefyrPage> {
  ...
  void dispose() {
    _sub.cancel();
    var result =json.encode(_controller.document.toDelta());
    print(
        "_controller.document   markDown:    \n$result");

    print(
        "_controller.document   ====:    \n${result==doc}");
    print(
        "_controller.document.toDelta()   markDown:    \n${NotusMarkdownCodec().encode(_controller.document.toDelta())}");
    super.dispose();
  }
